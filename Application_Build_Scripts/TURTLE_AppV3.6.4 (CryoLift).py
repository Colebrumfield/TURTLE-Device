...
class ThermocoupleUI(QMainWindow):
    ...
    def setup_ui(self):
        ...
        self.CryoLift_check = QCheckBox("Activate CryoLift")
        self.CryoLift_check.setFont(self.font)
        options_layout.addWidget(self.CryoLift_check)
        self.CryoLift_check.toggled.connect(self.handle_cryo_lift)
    ...
    def handle_cryo_lift(self, checked):
        if checked:
            self.send_to_arduino("Cryo:ON")
        else:
            self.send_to_arduino("Cryo:OFF")
