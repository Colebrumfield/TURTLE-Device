...
class ThermocoupleUI(QMainWindow):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("AGGRC TURTLE App Version 3.6")
        ...
        main_window_icon_path = os.path.join(self.resource_dir, 'Turtle_Icon.ico')
    ...
    def setup_ui(self):
        ...
        self.sampling_rate_combobox.setFixedWidth(375)
        ...
        self.thermocouple_type_combobox.setFixedWidth(325)
                    ...
                    if self.ser.in_waiting > 0:
                        ...
                        for data in temp_data:
                            ...
                            if status == "NC":
                                ...
                                self.connection_status_labels[index].setStyleSheet("background-color: #333; color: #808080; padding: 5px; border-radius: 10px;")
